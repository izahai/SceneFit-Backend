...
class MethodClient:
    ...
    def vlm_composed_retrieval(self, image_file: str = None, image_data: bytes = None, **kwargs) -> Dict[str, Any]:
        """
        Call the VLM vlm_composed_retrieval endpoint.
        ...
        try:
            return self._make_request("vlm_composed_retrieval", method="POST", files=files, **kwargs)
        finally:
            if files and image_file:
                files["file"].close()
        ...
        **kwargs
        ...
        for name, client in self.clients.items():
            try:
                ...
                elif endpoint == "vlm_composed_retrieval":
                    results[name] = client.vlm_composed_retrieval(
                        image_file=image_file,
                        image_data=image_data,
                        **kwargs
                    )
